...
const (
	HeartbeatService_Ping_FullMethodName = "/heartbeat.HeartbeatService/Ping"
)
...
type HeartbeatServiceClient interface {
	Ping(ctx context.Context, in *HeartbeatPing, opts ...grpc.CallOption) (*HeartbeatPong, error)
}
...
func (c *heartbeatServiceClient) Ping(ctx context.Context, in *HeartbeatPing, opts ...grpc.CallOption) (*HeartbeatPong, error) {
...
type HeartbeatServiceServer interface {
	Ping(context.Context, *HeartbeatPing) (*HeartbeatPong, error)
...
func (UnimplementedHeartbeatServiceServer) Ping(context.Context, *HeartbeatPing) (*HeartbeatPong, error) {
...
func _HeartbeatService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HeartbeatServiceServer).Ping(ctx, req.(*HeartbeatPing))
	}
